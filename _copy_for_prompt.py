...
How to improve live subtitles server so that the generated english text doesn't need to include the previous text in history if the transcribed overlapping starting audio is the same in meaning?
""".strip()
