...
Analyze the info shown on each plot in audio_tagger_chunk_plots.py
Now revise tags.html to replace all existing charts that follows each plot from audio_tagger_chunk_plots.
""".strip()
