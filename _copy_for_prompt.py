...
include_files = [
    ...
    r"C:\Users\druiv\Desktop\Jet_Files\Jet_Windows_Workspace\servers\live_subtitles\audio_search.py",
    r"C:\Users\druiv\Desktop\Jet_Files\Jet_Windows_Workspace\servers\live_subtitles\ja_punctuator.py",
    r"",
]
...
- Update live_subtitles_server2 to compare the current and previous audio bytes to replace this search audio call
search_audio(full_audio_bytes, audio_bytes)

- Add new arg in ja_punctuator add_punctuation that will replace spaces within each text with the provided character. Make it optional with default None.
""".strip()
