...
Refactor to break into smaller html fragments. Apply DRY principle as well. Do not break existing features
Write all as a single powershell .ps1 script, that I can run under templates\tagger directory
""".strip()
