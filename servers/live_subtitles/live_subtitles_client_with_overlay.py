                    ...
                    if chunk_type == "speech":
                        ...
                        if not is_speech_ongoing:
                            ...
                            try:
                                ...
                                log.success(
                                    "[speech → server] Sent start_of_utterance marker",
                                    bright=True,
                                )
                            except websockets.ConnectionClosed:
                        ...
                        if (
                            ...
                            if speech_duration_sec < config.min_speech_duration:
                                ...
                                try:
                                    ...
                                    log.info(
                                        "[speech → server] Sent end_of_utterance (discarded)"
                                    )
                                except websockets.ConnectionClosed:
                                    log.warning(
                                        "WebSocket closed while sending discarded end marker"
                                    )
                                    return
                            ...
                            if (
                                ...
                                wavfile.write(
                                    ...
                                    config.sample_rate,
                                    np.frombuffer(
                                        current_segment_buffer, dtype=np.int16
                                    ),
                                )
                                base_time = (
                                    stream_start_time
                            ...
                            try:
                                ...
                                log.success(
                                    "[speech → server] Sent end_of_utterance marker",
                                    bright=True,
                                )
                            except websockets.ConnectionClosed:
                                log.warning("WebSocket closed while sending end marker")
