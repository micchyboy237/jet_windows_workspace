...
if args.double_check_min_duration is not None:
    console.print(
        f"[cyan]double_check_min_duration={args.double_check_min_duration:.3f}s[/cyan]"
    )
console.print(
...
segments_with_audio, probs = extract_trough_to_trough(
    ...
    double_check_min_duration_s=args.double_check_min_duration,
